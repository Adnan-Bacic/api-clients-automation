...
final class RecommendIndexSettings{
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RecommendIndexSettings &&
     ...
     other.allowCompressionOfIntegerArray == allowCompressionOfIntegerArray &&
     other.numericAttributesForFiltering == numericAttributesForFiltering &&
     ...
     other.restrictHighlightAndSnippetArrays == restrictHighlightAndSnippetArrays &&
     ...
     other.disableTypoToleranceOnAttributes == disableTypoToleranceOnAttributes &&
     ...
     other.attributeCriteriaComputedByMinProximity == attributeCriteriaComputedByMinProximity &&
  ...
  factory RecommendIndexSettings.fromJson(Map<String, dynamic> json) => _$RecommendIndexSettingsFromJson(json);
