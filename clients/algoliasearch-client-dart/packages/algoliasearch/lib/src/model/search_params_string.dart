...
final class SearchParamsString{
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SearchParamsString &&
     other.params == params
    ;
  ...
  factory SearchParamsString.fromJson(Map<String, dynamic> json) => _$SearchParamsStringFromJson(json);
