...
final class BaseGetApiKeyResponse{
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BaseGetApiKeyResponse &&
     other.value == value &&
  ...
  factory BaseGetApiKeyResponse.fromJson(Map<String, dynamic> json) => _$BaseGetApiKeyResponseFromJson(json);
