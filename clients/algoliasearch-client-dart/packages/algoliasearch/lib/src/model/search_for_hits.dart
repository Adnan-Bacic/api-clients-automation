...
final class SearchForHits{
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SearchForHits &&
     other.params == params &&
     other.query == query &&
  ...
  factory SearchForHits.fromJson(Map<String, dynamic> json) => _$SearchForHitsFromJson(json);
