...
final class RedirectRuleIndexMetadata{
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RedirectRuleIndexMetadata &&
     other.source == source &&
     other.dest == dest &&
     other.reason == reason &&
  ...
  factory RedirectRuleIndexMetadata.fromJson(Map<String, dynamic> json) => _$RedirectRuleIndexMetadataFromJson(json);
