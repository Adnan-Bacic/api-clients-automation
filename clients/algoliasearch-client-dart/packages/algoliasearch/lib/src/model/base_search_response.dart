...
final class BaseSearchResponse extends DelegatingMap<String, dynamic> {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BaseSearchResponse &&
  ...
  factory BaseSearchResponse.fromJson(Map<String, dynamic> json) {
     ...
     final additionalProperties = Map<String, dynamic>.from(json)
      ..removeWhere((key, value) => _$BaseSearchResponseFieldMap.containsKey(key));
  ...
  Map<String, dynamic> toJson() => _$BaseSearchResponseToJson(this)..addAll(this);
