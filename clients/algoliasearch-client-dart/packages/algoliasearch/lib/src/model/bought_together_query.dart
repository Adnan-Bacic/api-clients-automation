...
final class BoughtTogetherQuery{
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BoughtTogetherQuery &&
  ...
  factory BoughtTogetherQuery.fromJson(Map<String, dynamic> json) => _$BoughtTogetherQueryFromJson(json);
