...
final class InsightsEvents{
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InsightsEvents &&
     other.events == events
    ;
  ...
  factory InsightsEvents.fromJson(Map<String, dynamic> json) => _$InsightsEventsFromJson(json);
