  ...
  ReturnType deserialize<ReturnType, BaseType>(dynamic value, String targetType, {bool growable= true}) {
      switch (targetType) {
        ...
        case 'AddedToCartObjectIDs':
          return AddedToCartObjectIDs.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AddedToCartObjectIDsAfterSearch':
          return AddedToCartObjectIDsAfterSearch.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ClickEvent':
          return ClickEvent.fromJson(value) as ReturnType;
        case 'ClickedFilters':
          return ClickedFilters.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ClickedObjectIDs':
          return ClickedObjectIDs.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ClickedObjectIDsAfterSearch':
          return ClickedObjectIDsAfterSearch.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ConversionEvent':
          return ConversionEvent.fromJson(value) as ReturnType;
        case 'ConvertedFilters':
          return ConvertedFilters.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ConvertedObjectIDs':
          return ConvertedObjectIDs.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ConvertedObjectIDsAfterSearch':
          return ConvertedObjectIDsAfterSearch.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ErrorBase':
          return ErrorBase.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'EventsResponse':
          return EventsResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'InsightsEvents':
          return InsightsEvents.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ObjectData':
          return ObjectData.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ObjectDataAfterSearch':
          return ObjectDataAfterSearch.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'PurchaseEvent':
          return PurchaseEvent.fromJson(value) as ReturnType;
        case 'PurchasedObjectIDs':
          return PurchasedObjectIDs.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'PurchasedObjectIDsAfterSearch':
          return PurchasedObjectIDsAfterSearch.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ViewEvent':
          return ViewEvent.fromJson(value) as ReturnType;
        case 'ViewedFilters':
          return ViewedFilters.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ViewedObjectIDs':
          return ViewedObjectIDs.fromJson(value as Map<String, dynamic>) as ReturnType;
        default:
          RegExpMatch? match;
