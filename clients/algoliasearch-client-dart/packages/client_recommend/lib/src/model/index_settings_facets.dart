...
final class IndexSettingsFacets{
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IndexSettingsFacets &&
     other.order == order
    ;
  ...
  factory IndexSettingsFacets.fromJson(Map<String, dynamic> json) => _$IndexSettingsFacetsFromJson(json);
