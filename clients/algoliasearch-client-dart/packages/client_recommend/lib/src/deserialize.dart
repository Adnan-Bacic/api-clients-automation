  ...
  ReturnType deserialize<ReturnType, BaseType>(dynamic value, String targetType, {bool growable= true}) {
      switch (targetType) {
        ...
        case 'AutoFacetFilter':
          return AutoFacetFilter.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'BaseRecommendIndexSettings':
          return BaseRecommendIndexSettings.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'BaseRecommendRequest':
          return BaseRecommendRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'BaseRecommendSearchParams':
          return BaseRecommendSearchParams.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'BoughtTogetherQuery':
          return BoughtTogetherQuery.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Condition':
        ...
        case 'FrequentlyBoughtTogether':
          return FrequentlyBoughtTogether.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'GetRecommendTaskResponse':
          return GetRecommendTaskResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'GetRecommendationsParams':
          return GetRecommendationsParams.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'GetRecommendationsResponse':
          return GetRecommendationsResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'HideConsequenceObject':
          return HideConsequenceObject.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'IndexSettingsFacets':
          return IndexSettingsFacets.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'LookingSimilar':
          return LookingSimilar.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'LookingSimilarModel':
          return LookingSimilarModel.fromJson(value) as ReturnType;
        case 'LookingSimilarQuery':
          return LookingSimilarQuery.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'MatchLevel':
        ...
        case 'ParamsConsequence':
          return ParamsConsequence.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Personalization':
          return Personalization.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'PromoteConsequenceObject':
          return PromoteConsequenceObject.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'QueryType':
        ...
        case 'RecommendIndexSettings':
          return RecommendIndexSettings.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'RecommendModels':
          return RecommendModels.fromJson(value) as ReturnType;
        case 'RecommendRule':
          return RecommendRule.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'RecommendSearchParams':
          return RecommendSearchParams.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'RecommendationsHits':
          return RecommendationsHits.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'RecommendationsResults':
          return RecommendationsResults.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'RecommendedForYou':
          return RecommendedForYou.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'RecommendedForYouModel':
          return RecommendedForYouModel.fromJson(value) as ReturnType;
        case 'RecommendedForYouQuery':
          return RecommendedForYouQuery.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Redirect':
        ...
        case 'RelatedProducts':
          return RelatedProducts.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'RelatedQuery':
        ...
        case 'SearchRecommendRulesParams':
          return SearchRecommendRulesParams.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'SearchRecommendRulesResponse':
          return SearchRecommendRulesResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'TrendingFacetHit':
          return TrendingFacetHit.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'TrendingFacets':
          return TrendingFacets.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'TrendingFacetsModel':
          return TrendingFacetsModel.fromJson(value) as ReturnType;
        case 'TrendingFacetsQuery':
          return TrendingFacetsQuery.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'TrendingItems':
          return TrendingItems.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'TrendingItemsModel':
          return TrendingItemsModel.fromJson(value) as ReturnType;
        case 'TrendingItemsQuery':
          return TrendingItemsQuery.fromJson(value as Map<String, dynamic>) as ReturnType;
