...
final class BaseSearchParams{
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BaseSearchParams &&
     other.query == query &&
  ...
  factory BaseSearchParams.fromJson(Map<String, dynamic> json) => _$BaseSearchParamsFromJson(json);
