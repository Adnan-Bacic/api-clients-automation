...
final class SecuredApiKeyRestrictions{
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SecuredApiKeyRestrictions &&
  ...
  factory SecuredApiKeyRestrictions.fromJson(Map<String, dynamic> json) => _$SecuredApiKeyRestrictionsFromJson(json);
