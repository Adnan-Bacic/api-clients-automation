...
final class SearchForFacets{
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SearchForFacets &&
     other.params == params &&
     other.query == query &&
  ...
  factory SearchForFacets.fromJson(Map<String, dynamic> json) => _$SearchForFacetsFromJson(json);
