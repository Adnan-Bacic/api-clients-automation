...
final class SearchSynonymsResponse extends DelegatingMap<String, dynamic> {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SearchSynonymsResponse &&
     other.hits == hits &&
     other.nbHits == nbHits &&
  ...
  factory SearchSynonymsResponse.fromJson(Map<String, dynamic> json) {
     ...
     final additionalProperties = Map<String, dynamic>.from(json)
      ..removeWhere((key, value) => _$SearchSynonymsResponseFieldMap.containsKey(key));
  ...
  Map<String, dynamic> toJson() => _$SearchSynonymsResponseToJson(this)..addAll(this);
